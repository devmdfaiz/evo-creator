  ...
  return (
    <>
      <header className="py-3 px-5 md:px-10 border-b border-border flex justify-between items-center bg-card shadow">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent className="w-56">
                  <div>
                    ...
                    <div className="pl-2 pb-2 flex justify-start items-center gap-2">
                      <p>{data.user!.sub}</p>
                      <Button
                        variant="outline"
                        size="icon"
        ...
        <BankDetails
          isBankSheet={isBankSheet}
          setIsBankSheet={setIsBankSheet}
        />
                    ...
                    >
                      ...
                      <SelectContent>
                        {COUNTRY_LIST.states.map((state, i) => (
                          <SelectItem key={i} value={state.text}>
                            {state.text}
                          </SelectItem>
                        ))}
                      </SelectContent>
