        ...
        {paymentStatus === "paid" && (
          <div className="bg-white shadow overflow-hidden sm:rounded-lg mt-10">
            <div className="px-4 py-5 sm:px-6">
              ...
              <p className="mt-1 text-sm text-gray-600">
                Click the button below to download your digital product. You
                will also receive an email with the download link.
              </p>
              <div className="mt-4">
                <Button
              ...
              <p className="mt-4 text-sm text-gray-600">
                ...
                with the same phone number used to purchase, and you can
